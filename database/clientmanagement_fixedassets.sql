...
CREATE TABLE `fixedassets` (
  `fixedAssetId` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `createdby_fixed_fk_idx` (`createdBy`),
  CONSTRAINT `createdby_fixed_fk` FOREIGN KEY (`createdBy`) REFERENCES `user` (`userId`)
