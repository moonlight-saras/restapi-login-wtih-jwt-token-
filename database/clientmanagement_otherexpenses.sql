...
CREATE TABLE `otherexpenses` (
  `otherExpensesId` int NOT NULL AUTO_INCREMENT,
  `salary` decimal(10,2) DEFAULT NULL,
  `rent` decimal(10,2) DEFAULT NULL,
  `advertisement` decimal(10,2) DEFAULT NULL,
  `stationary` decimal(10,2) DEFAULT NULL,
  `telephone` decimal(10,2) DEFAULT NULL,
  `internet` decimal(10,2) DEFAULT NULL,
  `waterElectricity` decimal(10,2) DEFAULT NULL,
  `repairMaintainance` decimal(10,2) DEFAULT NULL,
  `staffWelfare` decimal(10,2) DEFAULT NULL,
  ...
  KEY `createdby_otherExpense_fk_idx` (`createdBy`),
  CONSTRAINT `createdby_otherExpense_fk` FOREIGN KEY (`createdBy`) REFERENCES `user` (`userId`)
